...
function CemberinCevresi(cemberinYaricapi) {
  return 2*Math.PI*cemberinYaricapi;
}
...
function CemberinAlani(cemberinYaricapi, piValue) {
  return piValue*Math.pow(cemberinYaricapi, 2);
}

/* (Oto test yok) Yukarıdaki CemberinAlani fonksiyonunu yarıçap = 15 vererek aşağıda çalıştırıp, sonucu konsolda gözlemleyin (console.log)  */

console.log(CemberinAlani(15, piValue));
...
const kucukSayilar = sayilar.filter(sayi => sayi < 500);
besyuzdenkucuksayilar.push(kucukSayilar);
